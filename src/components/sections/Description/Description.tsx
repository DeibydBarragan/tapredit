...
export default function Description({}: Props) {
  return (
    <Section>
      <div className='sm:w-11/12 md:w-9/12 lg:w-10/12 xl:w-6/12 2xl:w-5/12 px-5'>
        <h2>
          ¿Qué es Tapredit?
        </h2>
        ...
        <div className='flex flex-col-reverse sm:flex-row mt-10 gap-4 items-center'>
          ...
          <div className='w-full sm:w-8/12'>
            <p className='md:text-right'>
              convenciones de los datos y colores. Los cubos y su respectiva información se pueden remover
